...
describe("should be defined", () => {
    it("test endpint/api", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield req.get("/api");
        expect(response.text).toBe("imgname or params not found or null"); // test my endpint /api
    }));
    it("test resize imge", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield req.get("/api?imgname=test.jpg&width=200&height=200");
